      ...
      <Layout>
        <section className="mx-auto max-w-7xl text-lg">
          ...
          <p>
            ...
            <br />
            <br />
            I’ve also got {new Date().getFullYear() - 2002} years of experience
            as a graphic designer under my belt and a highly developed aesthetic
            and functional sense, great attention to detail and passion for
            quality.
            <br />
            <br />
